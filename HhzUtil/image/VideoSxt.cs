...
namespace HhzUtil.image
{
    ...
    public class VideoSxt
    {
        ...
        /// 实例化摄像头视频类
        /// </summary>
        /// <param name="handle">视频所放播放控件句柄</param>
        /// <param name="width">视频显示的宽度</param>
        /// <param name="height">视频显示的高度</param>
        public VideoSxt(IntPtr handle, int width, int height)
        {
